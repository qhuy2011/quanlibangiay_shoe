...
<head>
    <meta charset="UTF-8">
    <title>Đăng nhập Quản trị - SneakerHub</title>
...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
    ...
    <div class="bg-white p-10 rounded-2xl shadow-xl w-full max-w-md">
        <div class="text-center mb-8">
            ...
            <p class="text-gray-500 mt-2 font-medium">Đăng nhập vào trang quản trị</p>
        </div>
        ...
        <form action="{{ route('postLogin') }}" method="POST" class="space-y-6">
            @csrf
            <div>
                <label class="block text-gray-700 font-bold mb-2">Email của bạn</label>
                <div class="relative">
                    <i class="fas fa-envelope absolute left-4 top-1/2 transform -translate-y-1/2 text-gray-400"></i>
                    <input type="email" name="email" class="w-full pl-12 pr-4 py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-indigo-500 bg-gray-50 outline-none transition" placeholder="admin@gmail.com" required>
                </div>
            </div>
            ...
            <div class="text-center mt-4">
                <p class="text-gray-500 text-sm mb-2">
                    Chưa có tài khoản?
                    <a href="{{ route('register') }}" class="text-indigo-600 hover:text-indigo-800 font-medium">Đăng ký ngay</a>
                </p>
                <a href="/" class="text-gray-500 hover:text-indigo-600 text-sm font-medium"><i class="fas fa-arrow-left mr-1"></i> Quay lại trang chủ</a>
            </div>
        </form>
    </div>
